 ...
 * for storage in _local/p2p-sync-log (CONTRACT.md Section 5).
 *
 * Guards:
 *   G12 — Session timeout after idle period (checked via isTimedOut)
 */
public class P2pSession {
    ...
    /**
     * Record activity to prevent G12 timeout.
     */
     ...
     *                   or DEFAULT_IDLE_TIMEOUT_SEC for the 30-min G12 guard)
    ...
    /**
     * Check timeout using the default 30-minute guard (G12).
     */
    ...
    /**
     * Convert to JSON for _local/p2p-sync-log (CONTRACT.md Section 5).
     *
