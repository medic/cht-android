 ...
 * - _local/p2p-sync-log  (CHW side)  — CONTRACT.md Section 5
 * - _local/p2p-relay-log (Supervisor side) — CONTRACT.md Section 5
 *
...
public class P2pTracker {
     ...
     * from CONTRACT.md Section 5 (_local/p2p-relay-log format).
     */
