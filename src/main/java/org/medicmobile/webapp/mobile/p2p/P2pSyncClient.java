...
public class P2pSyncClient {
	...
	public String authenticate(String jwt) throws IOException, JSONException {
		...
		boolean ok = response.optBoolean(KEY_OK, false);
		if (ok) {
