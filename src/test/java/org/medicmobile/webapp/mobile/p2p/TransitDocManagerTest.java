...
/**
	...
	*
	* Guards:
	*   Classification is deterministic (handled by ScopeGuard, tested in ScopeGuardTest)
	*   Transit docs NEVER appear in UI (isTransitDoc used for filtering)
...
public class TransitDocManagerTest {
	...
	// ========================================================================
	// Performance — transit index lookup should be fast
	// ========================================================================
