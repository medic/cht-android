...
The APKs are named as follows: `medic-android-{version}-{brand}-{rendering-engine}-{architecture}-release.apk`

| Rendering engine | Architecture  | Android version | Notes |
|------------------|---------------|-----------------|--|
